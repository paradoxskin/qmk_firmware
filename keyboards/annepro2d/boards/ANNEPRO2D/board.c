...
#define OUT_BITS(PORT) (PBIT(PORT, C2) | PBIT(PORT, C1) | PBIT(PORT, C15) | PBIT(PORT, C14) | PBIT(PORT, C3) | PBIT(PORT, B2) | PBIT(PORT, B13) | PBIT(PORT, D3) | 0)
...
// Alternate Functions
// AP2D has no independent LED MCU, so there is no LED UART (B0/B1).
// BLE UART: PA4/PA5 USART1 AF6 (LINE_BT_UART_*).
// RGB: AW20216S on SPI0 (B3/B4/B5 AF5), CS B2 / EN D3 as GPIO.
#define AF_BITS(PORT, N) (PAFIO(PORT, N, LINE_BT_UART_TX, AFIO_USART) | PAFIO(PORT, N, LINE_BT_UART_RX, AFIO_USART) | PAFIO(PORT, N, B5, AFIO_SPI) | PAFIO(PORT, N, B4, AFIO_SPI) | PAFIO(PORT, N, B3, AFIO_SPI) | PAFIO(PORT, N, B2, AFIO_GPIO) | PAFIO(PORT, N, B13, AFIO_GPIO) | PAFIO(PORT, N, D3, AFIO_GPIO) | PAFIO(PORT, N, C2, AFIO_GPIO) | PAFIO(PORT, N, C1, AFIO_GPIO) | PAFIO(PORT, N, C15, AFIO_GPIO) | PAFIO(PORT, N, C14, AFIO_GPIO) | PAFIO(PORT, N, C3, AFIO_GPIO) | PAFIO(PORT, N, C4, AFIO_GPIO) | PAFIO(PORT, N, C5, AFIO_GPIO) | PAFIO(PORT, N, C8, AFIO_GPIO) | PAFIO(PORT, N, C0, AFIO_GPIO) | PAFIO(PORT, N, A10, AFIO_GPIO) | PAFIO(PORT, N, B1, AFIO_GPIO) | PAFIO(PORT, N, A8, AFIO_GPIO) | PAFIO(PORT, N, C13, AFIO_GPIO) | PAFIO(PORT, N, C12, AFIO_GPIO) | PAFIO(PORT, N, A15, AFIO_GPIO) | PAFIO(PORT, N, A14, AFIO_GPIO) | PAFIO(PORT, N, A11, AFIO_GPIO) | PAFIO(PORT, N, D1, AFIO_GPIO) | PAFIO(PORT, N, D2, AFIO_GPIO) | 0)
